...
import com.eatza.order.feignclient.RestaurantClient;
...
//			restTemplate.setMessageConverters(messageConverters);
			try {
				...
				ItemFetchDto item = restaurantClient.getItemById(itemDto.getItemId());
		...
		template.send("orders",savedOrder.getId(),savedOrder);
		return savedOrder;
	}
